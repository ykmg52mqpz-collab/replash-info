...
// Facility share per video sold (15% of total video price; price kept private).
  ...
  return (
    <section className="section-y border-t border-white/5 bg-ink-900 relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 60% 50% at 50% 50%, rgba(253,230,138,0.10), transparent 70%)" }}
        aria-hidden
      />
      ...
      <div className="container-x relative z-10">
        ...
        >
          ...
          {/* Results */}
          <div className="mb-3 text-center text-[10px] font-bold uppercase tracking-widest text-accent/70">
            {t("results.eyebrow")}
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <ResultCard
              ...
              value={monthlyVideos.toLocaleString()}
              hint={t("results.videosHint")}
            />
            <ResultCard
